        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">
                    ...
                    <input type="button" value="增加" class="btn_add" onclick="location.href='${pageContext.request.contextPath}/role/ShowAllRoleAction.do';" />
                </div>
                <!--删除和密码重置的操作提示-->
                    ...
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>${admin.createTime }</td>
                             <td>
                                <a class="summary"  onmouseover="showDetail(true,this);" onmouseout="showDetail(false,this);">${admin.lr_String }</a>
                                <!--浮动的详细信息-->
                                <div class="detail_info">${admin.lr_String }
                                </div>
                            </td>
                            <td class="td_modi">
